 ...
 */
    ...
    i18n.eltos.gui.fr = {
		...
		"States":			"États",
		"Control States":		"États de contrôle",
		"Dependencies":			"Dépendances",
		"Close":			"Fermer",
		"Description": 		        "Détalle",
		"Show":				"Afficher",
		"Show Main Memory":		"Afficher la mémoire principale",
		"compile":			"compiler",
		"Compile":			"Compiler",
		"Please write the file name":	"Merci d'écrire le nom du fichier",
		"Load from this File":		"Charger à partir de ce fichier",
		"labels":			"étiquettes",
		"addr":				"adr",
		"ess":				"esse",
		"content":			"content",
		...
		"instructions":			"instructions",
                ...
                "simulator intro 1": "Vous pouvez sélectionner le matériel à utiliser. Le matériel par défaut est le matériel EP (Elemental Processor). <br> Vous pouvez utiliser <span class='text-primary bg-secondary-bg' onclick=\"setTimeout(function(){$('#dd1').dropdown('toggle');},50);\">le sélecteur de mode</span> pour changer le matériel utilisé.",

                "simulator intro 2": "Vous devez ensuite charger le microcode (définit le jeu d'instructions) et le code d'assemblage. <br> Vous pouvez utiliser <span class='text-primary bg-secondary-bg' onclick='wsweb_dialog_open(\"examples\");'>un exemple</span>, <span class='text-primary bg-secondary-bg' onclick='wsweb_select_action(\"checkpoint\");'>chargez-le à partir d'un fichier</span>, ou vous pouvez modifier <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_microcode();'>un nouveau microcode</span> et <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_assembly();'>un nouveau code d'assemblage</span>.",
...
                "simulator intro 3": "Enfin, dans le simulateur, vous pouvez exécuter le microcode plus l'assembly chargé auparavant. <br> Vous pouvez l'exécuter simultanément, au niveau de la microinstruction ou au niveau de l'instruction d'assemblage.",
		...
		"Next":				"Next",
		"End":				"End",
		"Disable tutorial mode":	"Désactiver le mode tutoriel",
		"Comment":			"Commentaire",
		"Pause":			"Pause",
		"Play":				"Lecture",
		"Stop":				"Arrêt",
		...
		"I/O Stats":			"E/S Statistiques",
		"I/O Configuration":		"E/S Configuration",
		"Recent":			"Récent",
		"Refresh":			"Actualiser",
		"Welcome":			"Bienvenue",
