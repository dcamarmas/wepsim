 ...
 */
    ...
    i18n.eltos.gui.sv = {
		...
		'Behaviors':			'Beteenden',
		'States':			'Stater',
		'Control States':		'Kontrollstater',
		'Dependencies':			'beroenden',
		'Close':			'Stänga',
		'Description':			'Beskrivning',
		'Show':				'Show',
		'Show Main Memory':		'Visa huvudminne',
		'compile':			'sammanställa',
		'Compile':			'Sammanställa',
		'Please write the file name':	'Vänligen skriv filnamnet',
		'Load from this File':		'Ladda från den här filen',
		'labels':			'etiketter',
		'addr':				'addr',
		'ess':				'ess',
		'content':			'innehåll',
...
                                        "Du kan använda <span class='text-primary bg-secondary-bg' onclick=\"setTimeout(function(){$('#dd1').dropdown('toggle');},50);\">lägesväljaren</span> för att ändra maskinvaran som används.",

                "simulator intro 2":    "Då måste du ladda mikrokoden (definierar instruktionsuppsättningen) och monteringskoden. <br>" +
                                        "Du kan använda <span class='text-primary bg-secondary-bg' onclick='wsweb_dialog_open(\"examples\");'>ett exempel</span>," +
                                        "<span class='text-primary bg-secondary-bg' onclick='wsweb_select_action(\"checkpoint\");'>ladda den från en fil</span>," +
                                        "eller så kan du redigera <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_microcode();'>en ny mikrokod</span>" +
                                        "och <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_assemble();'>en ny monteringskod</span>.",
...
                                        "Du kan köra det båda, på mikroinstruktionsnivå eller monteringsinstruktionsnivå.",
		...
		'Next':				'Nästa',
		'End':				'Slutet',
		'Disable tutorial mode':	'Inaktivera handledningsläge',
		'Comment':			'Kommentar',
		'Pause':			'Paus',
		'Play':				'Spela',
		'Stop':				'Sluta',
		...
		'Refresh':			'Uppdatera',
		'Welcome':			'Välkommen',
                'Microcode & Assembly':      	'WepSIM-hårdvara',
                'Pick firm/soft':  		'Välj fast programvara / programvara från',
                'Information':     		'Information från',
                'Native':   			'Inföding',
                'MIPS32-like':     		'MIPS32-liknande kod',
                'RISCV32':  			'RISCV32-kod',
