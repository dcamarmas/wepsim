 ...
 */
    ...
    i18n.eltos.gui.it = {
		...
		'States':			'Stati',
		'Control States':		'Stati di controllo',
		'Dependencies':			'Dipendenze',
		'Close':			'Vicino',
		'Description':			'Descrizione',
		'Show':				'Mostrare',
		'Show Main Memory':		'Mostra la memoria principale',
		'compile':			'compilare',
		'Compile':			'Compilare',
		'Please write the file name':	'Si prega di scrivere il nome del file',
		'Load from this File':		'Carica da questo file',
		'labels':			'etichette',
		'addr':				'addr',
		'ess':				'ess',
		'content':			'soddisfare',
		...
		'instructions':			'Istruzioni',
                ...
                "simulator intro 1": "È possibile selezionare l'hardware da utilizzare. Quello predefinito è l'hardware EP (Elemental Processor). <br> È possibile utilizzare <span class='text-primary bg-secondary-bg' onclick=\"setTimeout(function(){$('#dd1').dropdown('toggle');},50);\">il selettore di modalità</span> per modificare l'hardware utilizzato.",

                 "simulator intro 2": "Quindi devi caricare il microcodice (definisce il set di istruzioni) e il codice assembly. <br> Puoi usare <span class='text-primary bg-secondary-bg' onclick='wsweb_dialog_open(\"examples\");'> un esempio </span>,  <span class = 'text-primary bg-secondary-bg' onclick = 'wsweb_select_action(\"checkpoint\");'>caricalo da un file</span>, oppure puoi modificare <span class='text-primary bg-secondary-bg 'onclick='wsweb_change_workspace_microcode();'>un nuovo microcodice</span> e <span class ='text-primary bg-secondary-bg 'onclick='wsweb_change_workspace_assembly();'>un nuovo codice assembly</span>. ",
...
                 "simulator intro 3": "Infine, nel simulatore è possibile eseguire il microcodice più assembly precedentemente caricato. <br> È possibile eseguirlo entrambi, a livello di microistruzione o di istruzione di assembly.",
		...
		'Next':				'Il prossimo',
		'End':				'Fine',
		'Disable tutorial mode':	'Disattiva la modalità tutorial',
		'Comment':			'Commento',
		'Pause':			'Pausa',
		'Play':				'Giocare',
		'Stop':				'Fermare',
		...
		'I/O Stats':			'I/O Stats',
		'I/O Configuration':		'I/O Configurazione',
		'Recent':			'Recente',
		'Refresh':			'Ricaricare',
	        "Welcome":			'Benvenuto',
                'Microcode & Assembly':      	'Hardware WepSIM',
                'Pick firm/soft':  		'Scegli il firmware / software da',
                'Information':     		'Informazioni da',
                'Native':   			'Nativo',
