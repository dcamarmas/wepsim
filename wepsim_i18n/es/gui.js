    ...
    i18n.eltos.gui.es = {
		...
		"Please write the file name": 		        "Por favor indique el nombre de fichero",
	        ...
	        "instructions":                                 "instrucciones",
                ...
                "simulator intro 1": "Puede seleccionar el hardware que se utilizar&aacute;. El predeterminado es el hardware EP (Elemental Processor). <br> Puede usar <span class='text-primary bg-secondary-bg' onclick=\"setTimeout(function(){$('#dd1').dropdown('toggle');},50);\">el selector de modo</span> para cambiar el hardware utilizado",

                "simulator intro 2": "A continuaci&oacute;n necesita cargar el microc&oacute;digo (define el conjunto de instrucciones) y el c&oacute;digo de ensamblador. <br> Puede usar <span class='text-primary bg-secondary-bg' onclick='wsweb_dialog_open(\"examples\");'>un ejemplo</span>, <span class='text-primary bg-secondary-bg' onclick='wsweb_select_action(\"checkpoint\");;'>cargarlo desde un archivo</span>, o puede editar <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_microcode();'>un nuevo microc&oacute;digo</span> y <span class='text-primary bg-secondary-bg' onclick='wsweb_change_workspace_assembly();'>un nuevo c&oacute;digo de ensamblador</span>.",
...
                "simulator intro 3": "Finalmente, en el simulador puede ejecutar el microc&oacute;digo m&aacute;s el ensamblador cargado antes. <br> Puede ejecutar ambos, en el nivel de microinstrucci&oacute;n o en el nivel de instrucci&oacute;n de ensamblador.",
		...
		"Welcome":					"Bienvenido+a",
                ...
                "Pick firm/soft":  				"Firm/soft desde",
                "Information":     				"Informaci&oacute;n",
                "Native":          				"Nativo",
                "MIPS32-like":          			"Basado en MIPS32",
                "RISCV32":          				"RISCV32",
                "Z80-like":          				"Basado en Z80",
